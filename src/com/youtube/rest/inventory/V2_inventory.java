...
public class V2_inventory {
	...
	public Response returnBrandParts(@QueryParam("brand") String brand) throws Exception{ //...v2/inventory?brand={value}
	...
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	public Response returnBrand(@PathParam("brand") String brand) throws Exception { //...v2/inventory/{value}
